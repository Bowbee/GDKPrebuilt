...
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_UGenerateSchemaAndSnapshotsCommandlet_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UGenerateSchemaCommandlet,
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGenerateSchemaAndSnapshotsCommandlet_Statics::ClassParams = {
		...
		0x000000A8u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_UGenerateSchemaAndSnapshotsCommandlet_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGenerateSchemaAndSnapshotsCommandlet_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UGenerateSchemaAndSnapshotsCommandlet, 1818838422);
