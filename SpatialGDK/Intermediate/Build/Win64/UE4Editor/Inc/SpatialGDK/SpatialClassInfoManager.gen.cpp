...
static struct FScriptStruct_SpatialGDK_StaticRegisterNativesFClassInfo
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FClassInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FClassInfo_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClassInfo_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FClassInfo_Hash() { return 3399828153U; }
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USpatialClassInfoManager_Statics::NewProp_NetDriver = { "NetDriver", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USpatialClassInfoManager, NetDriver), Z_Construct_UClass_USpatialNetDriver_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USpatialClassInfoManager_Statics::NewProp_NetDriver_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USpatialClassInfoManager_Statics::NewProp_NetDriver_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USpatialClassInfoManager_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_USpatialClassInfoManager_Statics::PropPointers),
		0,
		0x001000A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_USpatialClassInfoManager_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USpatialClassInfoManager_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USpatialClassInfoManager, 3105259680);
