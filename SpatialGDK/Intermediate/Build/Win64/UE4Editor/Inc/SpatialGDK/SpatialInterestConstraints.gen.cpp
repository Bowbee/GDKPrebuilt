...
static struct FScriptStruct_SpatialGDK_StaticRegisterNativesFQueryData
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FQueryData_Statics::NewProp_Frequency_MetaData[] = {
		{ "Category", "SpatialGDK" },
		{ "ClampMin", "0.000000" },
		{ "Comment", "/**\n\x09 * Used for frequency-based rate limiting. Represents the maximum frequency\n\x09 * of updates for this particular query. An empty option represents no\n\x09 * rate-limiting (ie. updates are received as soon as possible). Frequency\n\x09 * is measured in Hz.\n\x09 *\n\x09 * If set, the time between consecutive updates will be at least\n\x09 * 1/frequency. This is determined at the time that updates are sent from\n\x09 * the Runtime and may not necessarily correspond to the time updates are\n\x09 * received by the worker.\n\x09 *\n\x09 * If after an update has been sent, multiple updates are applied to a\n\x09 * component, they will be merged and sent as a single update after\n\x09 * 1/frequency of the last sent update. When components with events are\n\x09 * merged, the resultant component will contain a concatenation of all the\n\x09 * events.\n\x09 *\n\x09 * If multiple queries match the same Entity-Component then the highest of\n\x09 * all frequencies is used.\n\x09 */" },
		{ "ModuleRelativePath", "Public/Interop/SpatialInterestConstraints.h" },
		{ "ToolTip", "Used for frequency-based rate limiting. Represents the maximum frequency\nof updates for this particular query. An empty option represents no\nrate-limiting (ie. updates are received as soon as possible). Frequency\nis measured in Hz.\n\nIf set, the time between consecutive updates will be at least\n1/frequency. This is determined at the time that updates are sent from\nthe Runtime and may not necessarily correspond to the time updates are\nreceived by the worker.\n\nIf after an update has been sent, multiple updates are applied to a\ncomponent, they will be merged and sent as a single update after\n1/frequency of the last sent update. When components with events are\nmerged, the resultant component will contain a concatenation of all the\nevents.\n\nIf multiple queries match the same Entity-Component then the highest of\nall frequencies is used." },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FQueryData_Statics::NewProp_Frequency = { "Frequency", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FQueryData, Frequency), METADATA_PARAMS(Z_Construct_UScriptStruct_FQueryData_Statics::NewProp_Frequency_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FQueryData_Statics::NewProp_Frequency_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FQueryData_Statics::NewProp_Constraint_MetaData[] = {
		{ "Category", "Query Data" },
		{ "Comment", "/**\n\x09 * The root constraint associated with the query generated by this component.\n\x09 */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Interop/SpatialInterestConstraints.h" },
		{ "ToolTip", "The root constraint associated with the query generated by this component." },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FQueryData_Statics::NewProp_Constraint = { "Constraint", nullptr, (EPropertyFlags)0x001200000009001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FQueryData, Constraint), Z_Construct_UClass_UAbstractQueryConstraint_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FQueryData_Statics::NewProp_Constraint_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FQueryData_Statics::NewProp_Constraint_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FQueryData_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FQueryData_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000205),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FQueryData_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FQueryData_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FQueryData_Hash() { return 636587791U; }
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAbstractQueryConstraint_Statics::ClassParams = {
		...
		0x001000A1u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_UAbstractQueryConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAbstractQueryConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAbstractQueryConstraint, 573643542);
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UOrConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UOrConstraint_Statics::PropPointers),
		0,
		0x00B010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_UOrConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UOrConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UOrConstraint, 4087256576);
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndConstraint_Statics::NewProp_Constraints_MetaData[] = {
		...
		{ "Comment", "/** Entities captured by all subconstraints will be included in interest results. */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Interop/SpatialInterestConstraints.h" },
		{ "ToolTip", "Entities captured by all subconstraints will be included in interest results." },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAndConstraint_Statics::NewProp_Constraints = { "Constraints", nullptr, (EPropertyFlags)0x001000800001001d, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndConstraint, Constraints), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAndConstraint_Statics::NewProp_Constraints_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndConstraint_Statics::NewProp_Constraints_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAndConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UAndConstraint_Statics::PropPointers),
		0,
		0x00B010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_UAndConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAndConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAndConstraint, 560906074);
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USphereConstraint_Statics::NewProp_Radius_MetaData[] = {
		...
		{ "ClampMin", "0.000000" },
		{ "Comment", "/** The size of the sphere represented by this constraint in centimeters. */" },
		{ "ModuleRelativePath", "Public/Interop/SpatialInterestConstraints.h" },
		{ "ToolTip", "The size of the sphere represented by this constraint in centimeters." },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USphereConstraint_Statics::NewProp_Radius = { "Radius", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USphereConstraint, Radius), METADATA_PARAMS(Z_Construct_UClass_USphereConstraint_Statics::NewProp_Radius_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USphereConstraint_Statics::NewProp_Radius_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USphereConstraint_Statics::NewProp_Center_MetaData[] = {
		{ "Category", "Sphere Constraint" },
		{ "Comment", "/** The location in the world that this constraint is relative to. */" },
		{ "ModuleRelativePath", "Public/Interop/SpatialInterestConstraints.h" },
		{ "ToolTip", "The location in the world that this constraint is relative to." },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USphereConstraint_Statics::NewProp_Center = { "Center", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USphereConstraint, Center), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_USphereConstraint_Statics::NewProp_Center_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USphereConstraint_Statics::NewProp_Center_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USphereConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_USphereConstraint_Statics::PropPointers),
		0,
		0x003010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_USphereConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USphereConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USphereConstraint, 1043971759);
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCylinderConstraint_Statics::NewProp_Radius_MetaData[] = {
		...
		{ "ClampMin", "0.000000" },
		{ "Comment", "/** The size of the cylinder represented by this constraint in centimeters. */" },
		{ "ModuleRelativePath", "Public/Interop/SpatialInterestConstraints.h" },
		{ "ToolTip", "The size of the cylinder represented by this constraint in centimeters." },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCylinderConstraint_Statics::NewProp_Radius = { "Radius", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCylinderConstraint, Radius), METADATA_PARAMS(Z_Construct_UClass_UCylinderConstraint_Statics::NewProp_Radius_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCylinderConstraint_Statics::NewProp_Radius_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UCylinderConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UCylinderConstraint_Statics::PropPointers),
		0,
		0x003010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_UCylinderConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UCylinderConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UCylinderConstraint, 650644472);
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBoxConstraint_Statics::NewProp_EdgeLengths_MetaData[] = {
		...
		{ "ClampMin", "0.000000" },
		{ "Comment", "/** The size of the box represented by this constraint. */" },
		{ "ModuleRelativePath", "Public/Interop/SpatialInterestConstraints.h" },
		{ "ToolTip", "The size of the box represented by this constraint." },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBoxConstraint_Statics::NewProp_EdgeLengths = { "EdgeLengths", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBoxConstraint, EdgeLengths), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UBoxConstraint_Statics::NewProp_EdgeLengths_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBoxConstraint_Statics::NewProp_EdgeLengths_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBoxConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UBoxConstraint_Statics::PropPointers),
		0,
		0x003010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_UBoxConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UBoxConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UBoxConstraint, 367399753);
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_URelativeSphereConstraint_Statics::NewProp_Radius = { "Radius", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URelativeSphereConstraint, Radius), METADATA_PARAMS(Z_Construct_UClass_URelativeSphereConstraint_Statics::NewProp_Radius_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URelativeSphereConstraint_Statics::NewProp_Radius_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_URelativeSphereConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_URelativeSphereConstraint_Statics::PropPointers),
		0,
		0x003010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_URelativeSphereConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_URelativeSphereConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(URelativeSphereConstraint, 3530552448);
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_URelativeCylinderConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_URelativeCylinderConstraint_Statics::PropPointers),
		0,
		0x003010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_URelativeCylinderConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_URelativeCylinderConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(URelativeCylinderConstraint, 93553247);
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_URelativeBoxConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_URelativeBoxConstraint_Statics::PropPointers),
		0,
		0x003010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_URelativeBoxConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_URelativeBoxConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(URelativeBoxConstraint, 3608590701);
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCheckoutRadiusConstraint_Statics::NewProp_Radius = { "Radius", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCheckoutRadiusConstraint, Radius), METADATA_PARAMS(Z_Construct_UClass_UCheckoutRadiusConstraint_Statics::NewProp_Radius_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCheckoutRadiusConstraint_Statics::NewProp_Radius_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UCheckoutRadiusConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UCheckoutRadiusConstraint_Statics::PropPointers),
		0,
		0x003010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_UCheckoutRadiusConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UCheckoutRadiusConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UCheckoutRadiusConstraint, 2506300995);
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorClassConstraint_Statics::NewProp_bIncludeDerivedClasses_MetaData[] = {
		...
		{ "Comment", "/** Whether this constraint should capture derived types. */" },
		{ "ModuleRelativePath", "Public/Interop/SpatialInterestConstraints.h" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorClassConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UActorClassConstraint_Statics::PropPointers),
		0,
		0x003010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_UActorClassConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UActorClassConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UActorClassConstraint, 2156744092);
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UComponentClassConstraint_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UComponentClassConstraint_Statics::PropPointers),
		0,
		0x003010A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_UComponentClassConstraint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UComponentClassConstraint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UComponentClassConstraint, 1154796947);
