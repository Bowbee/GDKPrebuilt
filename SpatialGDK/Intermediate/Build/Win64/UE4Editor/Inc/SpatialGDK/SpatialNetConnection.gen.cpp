...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USpatialNetConnection_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_USpatialNetConnection_Statics::PropPointers),
		0,
		0x001000ACu,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_USpatialNetConnection_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USpatialNetConnection_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USpatialNetConnection, 2285587542);
