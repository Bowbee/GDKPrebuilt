...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USpatialPendingNetGame_Statics::Class_MetaDataParams[] = {
		{ "Comment", "//UPendingNetGame needs to have its dllexport defined: \"class ENGINE_API UPendingNetGame\". This can count as a bug, we can submit a PR.\n" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USpatialPendingNetGame_Statics::ClassParams = {
		...
		0x000000A8u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_USpatialPendingNetGame_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USpatialPendingNetGame_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USpatialPendingNetGame, 3757749181);
