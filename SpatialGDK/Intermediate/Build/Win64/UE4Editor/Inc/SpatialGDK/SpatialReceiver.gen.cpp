...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USpatialReceiver_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_USpatialReceiver_Statics::PropPointers),
		0,
		0x000000A0u,
		0x00000000u,
		METADATA_PARAMS(Z_Construct_UClass_USpatialReceiver_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USpatialReceiver_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USpatialReceiver, 3905128518);
