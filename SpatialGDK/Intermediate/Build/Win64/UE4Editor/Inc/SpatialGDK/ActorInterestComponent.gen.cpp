...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorInterestComponent_Statics::NewProp_Queries_MetaData[] = {
		{ "Category", "Interest" },
		{ "Comment", "/**\n\x09 * The Queries associated with this component.\n\x09 */" },
		{ "ModuleRelativePath", "Public/EngineClasses/Components/ActorInterestComponent.h" },
		{ "ToolTip", "The Queries associated with this component." },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UActorInterestComponent_Statics::NewProp_Queries = { "Queries", nullptr, (EPropertyFlags)0x0010008000010015, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UActorInterestComponent, Queries), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UActorInterestComponent_Statics::NewProp_Queries_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UActorInterestComponent_Statics::NewProp_Queries_MetaData)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorInterestComponent_Statics::NewProp_bUseNetCullDistanceSquaredForCheckoutRadius_MetaData[] = {
		{ "Category", "Interest" },
		{ "Comment", "/**\n\x09 * Whether to use NetCullDistanceSquared to generate constraints relative to the Actor that this component is attached to.\n\x09 */" },
		{ "ModuleRelativePath", "Public/EngineClasses/Components/ActorInterestComponent.h" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorInterestComponent_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UActorInterestComponent_Statics::PropPointers),
		0,
		0x00B000A4u,
		0x00000008u,
		METADATA_PARAMS(Z_Construct_UClass_UActorInterestComponent_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UActorInterestComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UActorInterestComponent, 2354721713);
